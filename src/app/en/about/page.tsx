      ...
      <section className="relative z-10 py-32 md:py-52 px-6 text-center animate-reveal delay-4">
        <div className="container mx-auto">
            ...
            <div className="flex flex-col md:flex-row justify-center gap-6">
                <a href="/contact" className="px-12 py-6 bg-[#D4AF37] text-black font-black text-xs tracking-[0.4em] rounded-full shadow-[0_20px_50px_rgba(212,175,55,0.4)] hover:scale-105 active:scale-95 transition-all uppercase">
